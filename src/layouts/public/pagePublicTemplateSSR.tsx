 ...
 */
export const getServerSideProps: GetServerSideProps<GetPublicLayoutServerSidePropsResults, CommonServerSideParams> =
  getPublicLayoutServerSideProps();
...
const PagePublicTemplateSSR: NextPage<Props> = (props): JSX.Element => {
  ...
  return (
    <PublicLayout {...props}>
      <p>
        This page is a template meant to be duplicated into "/pages", to quickly get started with new Next.js{' '}
        <b>SSR pages</b>.<br />
      </p>
    </PublicLayout>
  );
