...
const MultiversalPageEntryPoint: React.FunctionComponent<Props> = (props): JSX.Element => {
  return (
    <>
      <Head>
        <title>ایران اچ‌آر | تجربه بهتر استخدام</title>
        <link rel="icon" href="https://web.site/favicon.png" />
        <meta name="description" content="موتور جستجوی موقعیت های شغلی در بیش از هفت پلتفرم کاریابی"></meta>
        <meta name="keywords" content="استخدام, منابع انسانی, شغل, بازار کار, کاریابی, آگهی شغلی, جذب نیرو, جستجو"></meta>
        ...
        <meta name="application-name" content="وب سایت"></meta>
        <script>
