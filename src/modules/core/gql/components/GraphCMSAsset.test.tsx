...
describe('GraphCMSAsset', () => {
  describe('should properly render an asset from GraphCMS', () => {
    describe('when the asset is used as an image (<img>)', () => {
      test('when relying on default "logos" property, it should apply the internal default properties', () => {
        const id = 'test';
      ...
      test('when using "logos" property, it should apply the properties correctly', () => {
        const id = 'test';
      ...
      describe('when using custom override', () => {
        test('when used with the "logos" property, it should override the logos props with the override values', () => {
          const id = 'test';
          const title = 'Test asset';
          const classes = 'test-class1 test-class2';
          const style = { paddingTop: 5 };
  ...
  describe('when the asset is used as a link(<a>) containing an image (<img>)', () => {
    test('when relying on default "logos" property', () => {
      const id = 'test';
  ...
  describe('should return null value', () => {
    test('when asset is empty', () => {
      const id = 'test';
      const classes = 'test-class1 test-class2';
      const style = { paddingTop: 5 };
      const renderer = TestRenderer.create(<GraphCMSAsset asset={{}} id={id} defaults={{ style, classes }} />);

      const instance: ReactTestInstance = renderer.getInstance();
